...
const handlestripePayment = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    const paymentIntent = await stripe.paymentIntents.create({
      ...
      metadata: {
        //actually id is a number in mongodb but for stripe we need it as a string
    ...
    console.log('PAYMENT INTENT OBJECT CREATED :', paymentIntent);
    //send the response
    res.json({
...
const verifyPayment = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    console.log('PAYMENT INTENT WHILE VERIFICATION :',paymentIntent);
